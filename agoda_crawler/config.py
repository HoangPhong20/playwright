...
CONFIG_ENV_KEYS = {
    ...
    "AGODA_FIELD_SELECTOR_TIMEOUT",
    "AGODA_CARD_SCROLL_TIMEOUT",
    "AGODA_LOAD_PAGE",
    ...
    "AGODA_LISTING_FAST_WAIT_MS",
    "AGODA_LISTING_STALL_WAIT_MS",
    "AGODA_LISTING_NETWORK_IDLE_STALL_ROUNDS",
...
CLICK_DEFAULT = env_int(_ENV, "AGODA_CLICK_DEFAULT", 3_000)
CLICK_NEXT_PAGE = env_int(_ENV, "AGODA_CLICK_NEXT_PAGE", 3_000)
FIELD_SELECTOR_TIMEOUT = env_int(_ENV, "AGODA_FIELD_SELECTOR_TIMEOUT", 700)
CARD_SCROLL_TIMEOUT = env_int(_ENV, "AGODA_CARD_SCROLL_TIMEOUT", 700)
...
LISTING_FAST_WAIT_MS = env_int(_ENV, "AGODA_LISTING_FAST_WAIT_MS", 200)
LISTING_STALL_WAIT_MS = env_int(_ENV, "AGODA_LISTING_STALL_WAIT_MS", 800)
LISTING_NETWORK_IDLE_STALL_ROUNDS = env_int(_ENV, "AGODA_LISTING_NETWORK_IDLE_STALL_ROUNDS", 1)
